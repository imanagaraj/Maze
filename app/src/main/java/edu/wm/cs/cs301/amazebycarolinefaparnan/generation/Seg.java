...
import edu.wm.cs.cs301.amazebycarolinefaparnan.falstad.MazeFileWriter;
...
public class Seg {
	...
	public Seg(int psx, int psy, int pdx, int pdy, int distance, int cc) {
		...
		switch (part2) {
		case 0: col = new MazePanel.GWColor(rgbValue, 20, 20);break;
		case 1: col = new MazePanel.GWColor(20, rgbValue, 20); break;
		case 2: col = new MazePanel.GWColor(20, 20, rgbValue); break;
		case 3: col = new MazePanel.GWColor(rgbValue, rgbValue, 20); break;
		case 4: col = new MazePanel.GWColor(20, rgbValue, rgbValue); break;
		case 5: col = new MazePanel.GWColor(rgbValue, 20, rgbValue); break;
		default: col = new MazePanel.GWColor(20, 20, 20); break;
		}
