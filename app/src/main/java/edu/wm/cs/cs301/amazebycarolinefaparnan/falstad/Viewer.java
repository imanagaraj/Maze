...
public interface Viewer {
	 ...
	 * @param ang
	 */
	public void redraw(MazePanel gc, StateGUI state, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, int ang) ;
	/** 
	...
	public void redraw(MazeController controller, StateGUI state, int px, int py, int view_dx, int view_dy, int walk_step,
